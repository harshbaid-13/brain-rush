  ...
  return (
    <>
      ...
      <div className="text-white flex justify-center items-center">
        <ul className="flex sm:m-16 m:4 gap-10 h-72 overflow-x-scroll scrollbar-thumb-logoYellow autoslide">
          {data.map((item) => (
            // <Swiper
            //   slidesPerView={4}
            //   spaceBetween={30}
            ...
            <li className="px-8 w-64 " key={item.id}>
              <Link href={item.whatsapp}>
                <div className="w-48 flex gap-3 flex-col justify-center items-center">
                  <img
                    className="h-48 w-48 object-cover shadow-lg rounded-full object-top align-middle border-none"
                    src={item.photo}
                    alt=""
                  />
