    ...
    return (
        <>
            ...
            <div className="text-white flex justify-center items-center">
                <ul className="flex m-16 gap-8 h-72 overflow-x-scroll">
                    {data.map((item) => (<li className="px-8 w-64 " key={item.id}>
                        <Link href={item.whatsapp}>
                            <div className="w-48 flex gap-3 flex-col justify-center items-center">
                                <img className="h-48 w-48 object-cover shadow-lg rounded-full object-top align-middle border-none" src={item.photo} alt="" />
                                <h1 className="text-2xl text-logoYellow">{item.name}</h1>
                            </div>
                        </Link>
                    </li>))}
                </ul>
