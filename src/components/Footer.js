    ...
    return (
        <footer className="p-4 sm:p-6 bg-gray-900">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center">By CSE Department </span>
  ...
  return (
    <footer className="p-4 sm:p-6 bg-gray-900">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <span className="text-4xl text-logoYellow sm:text-center">
          BRAINRUSH 2K23
        </span>
        <div className="flex  mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a href="#" className=" text-logoYellow hover:text-white">
            <svg
              className="w-10 h-10"
              fill="currentColor"
              viewBox="0 0 24 24"
